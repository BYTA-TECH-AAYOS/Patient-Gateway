...
public class TaskResponse   {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(assignee, category, createTime, delegationState, description, dueDate, executionId, executionUrl, formKey, id, name, owner, parentTaskId, parentTaskUrl, priority, processDefinitionId, processDefinitionUrl, processInstanceId, processInstanceUrl, suspended, taskDefinitionKey, tenantId, url, variables);
  }
