...
public interface AppointmentCommandResourceApi {
    ...
    @ApiOperation(value = "additionalInformationRequest", nickname = "additionalInformationRequestUsingPOST", notes = "", tags={ "appointment-command-resource", })
    @ApiResponses(value = { 
    ...
    ResponseEntity<Void> additionalInformationRequestUsingPOST(@ApiParam(value = "taskId",required=true) @PathVariable("taskId") String taskId,@ApiParam(value = "additionalInformationRequest" ,required=true )  @Valid @RequestBody AdditionalInformationRequest additionalInformationRequest);


    @ApiOperation(value = "chooseDoctor", nickname = "chooseDoctorUsingPOST", notes = "", tags={ "appointment-command-resource", })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "OK"),
        @ApiResponse(code = 201, message = "Created"),
        @ApiResponse(code = 401, message = "Unauthorized"),
    ...
    @RequestMapping(value = "/api/command/chooseDoctor/{taskId}",
        consumes = "application/json",
        method = RequestMethod.POST)
    ResponseEntity<Void> chooseDoctorUsingPOST(@ApiParam(value = "taskId",required=true) @PathVariable("taskId") String taskId,@ApiParam(value = "doctorInfo" ,required=true )  @Valid @RequestBody DoctorInfo doctorInfo);


    @ApiOperation(value = "collectAdditionalDetails", nickname = "collectAdditionalDetailsUsingPOST", notes = "", tags={ "appointment-command-resource", })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "OK"),
        @ApiResponse(code = 201, message = "Created"),
        @ApiResponse(code = 401, message = "Unauthorized"),
    ...
    @RequestMapping(value = "/api/command/collectAdditionalDetails/{taskId}",
        consumes = "application/json",
        method = RequestMethod.POST)
    ResponseEntity<Void> collectAdditionalDetailsUsingPOST(@ApiParam(value = "taskId",required=true) @PathVariable("taskId") String taskId,@ApiParam(value = "symptomDetails" ,required=true )  @Valid @RequestBody ConsultationDetails consultationDetails);


    @ApiOperation(value = "confirmPayment", nickname = "confirmPaymentUsingPOST", notes = "", tags={ "appointment-command-resource", })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "OK"),
        @ApiResponse(code = 201, message = "Created"),
        @ApiResponse(code = 401, message = "Unauthorized"),
    ...
    @RequestMapping(value = "/api/command/confirmPayment/{taskId}",
        consumes = "application/json",
        method = RequestMethod.POST)
    ResponseEntity<Void> confirmPaymentUsingPOST(@ApiParam(value = "taskId",required=true) @PathVariable("taskId") String taskId,@ApiParam(value = "paymentConfirmationRequest" ,required=true )  @Valid @RequestBody PaymentConfirmationRequest paymentConfirmationRequest);


    @ApiOperation(value = "confirmRegistration", nickname = "confirmRegistrationUsingPOST", notes = "", tags={ "appointment-command-resource", })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "OK"),
        @ApiResponse(code = 201, message = "Created"),
        @ApiResponse(code = 401, message = "Unauthorized"),
    ...
    @RequestMapping(value = "/api/command/confirmRegistartion/{taskId}",
        method = RequestMethod.POST)
    ResponseEntity<Void> confirmRegistrationUsingPOST(@ApiParam(value = "taskId",required=true) @PathVariable("taskId") String taskId);
    ...
    @ApiOperation(value = "initiateAppointment", nickname = "initiateAppointmentUsingPOST", notes = "", tags={ "appointment-command-resource", })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "OK"),
        @ApiResponse(code = 201, message = "Created"),
        @ApiResponse(code = 401, message = "Unauthorized"),
    ...
    @RequestMapping(value = "/api/command/initiateAppointment",
        consumes = "application/json",
        method = RequestMethod.POST)
    ResponseEntity<Void> initiateAppointmentUsingPOST(@ApiParam(value = "appointementRequest" ,required=true )  @Valid @RequestBody AppointmentRequest appointmentRequest);


    @ApiOperation(value = "processAppointmentRequest", nickname = "processAppointmentRequestUsingPOST", notes = "", tags={ "appointment-command-resource", })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "OK"),
        @ApiResponse(code = 201, message = "Created"),
        @ApiResponse(code = 401, message = "Unauthorized"),
    ...
    @RequestMapping(value = "/api/command/processAppointmentRequest/{taskId}",
        consumes = "application/json",
        method = RequestMethod.POST)
    ResponseEntity<Void> processAppointmentRequestUsingPOST(@ApiParam(value = "taskId",required=true) @PathVariable("taskId") String taskId,@ApiParam(value = "appointmentConfirmationResponse" ,required=true )  @Valid @RequestBody AppointmentConfirmationResponse appointmentConfirmationResponse);


    @ApiOperation(value = "processPayment", nickname = "processPaymentUsingPOST", notes = "", tags={ "appointment-command-resource", })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "OK"),
        @ApiResponse(code = 201, message = "Created"),
        @ApiResponse(code = 401, message = "Unauthorized"),
    ...
    @RequestMapping(value = "/api/command/processPayment/{taskId}",
        consumes = "application/json",
        method = RequestMethod.POST)
    ResponseEntity<Void> processPaymentUsingPOST(@ApiParam(value = "taskId",required=true) @PathVariable("taskId") String taskId,@ApiParam(value = "processPayment" ,required=true )  @Valid @RequestBody ProcessPayment processPayment);


    @ApiOperation(value = "selectSlot", nickname = "selectSlotUsingPOST", notes = "", tags={ "appointment-command-resource", })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "OK"),
        @ApiResponse(code = 201, message = "Created"),
        @ApiResponse(code = 401, message = "Unauthorized"),
    ...
    @RequestMapping(value = "/api/command/chooseSlot/{taskId}",
        consumes = "application/json",
        method = RequestMethod.POST)
    ResponseEntity<Void> selectSlotUsingPOST(@ApiParam(value = "taskId",required=true) @PathVariable("taskId") String taskId,@ApiParam(value = "slotSelectionRequest" ,required=true )  @Valid @RequestBody Slot slot);


    @ApiOperation(value = "sendAppointmentRequest", nickname = "sendAppointmentRequestUsingPOST", notes = "", tags={ "appointment-command-resource", })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "OK"),
        @ApiResponse(code = 201, message = "Created"),
        @ApiResponse(code = 401, message = "Unauthorized"),
    ...
    @RequestMapping(value = "/api/command/sendAppointmentRequest/{taskId}",
        consumes = "application/json",
        method = RequestMethod.POST)
    ResponseEntity<Void> sendAppointmentRequestUsingPOST(@ApiParam(value = "taskId",required=true) @PathVariable("taskId") String taskId,@ApiParam(value = "appointmentConfirmationRequest" ,required=true )  @Valid @RequestBody AppointmentConfirmationRequest appointmentConfirmationRequest);
