...
import com.bytatech.ayoos.patientapigateway.client.appointment.model.User;
import com.bytatech.ayoos.patientapigateway.client.appointment.model.UserDTO;
...
public interface UserResourceApi {
    ...
    @ApiOperation(value = "getCurrentUserLogin", nickname = "getCurrentUserLoginUsingGET", notes = "", response = String.class, tags={ "user-resource", })
    @ApiResponses(value = { 
    ...
    @RequestMapping(value = "/api/currentUser",
        produces = "*/*", 
        method = RequestMethod.GET)
    ResponseEntity<String> getCurrentUserLoginUsingGET();


    @ApiOperation(value = "getUserDetails", nickname = "getUserDetailsUsingGET", notes = "", response = User.class, tags={ "user-resource", })
    @ApiResponses(value = { 
    ...
    @RequestMapping(value = "/api/userDetails",
        produces = "*/*", 
        method = RequestMethod.GET)
    ResponseEntity<User> getUserDetailsUsingGET();
