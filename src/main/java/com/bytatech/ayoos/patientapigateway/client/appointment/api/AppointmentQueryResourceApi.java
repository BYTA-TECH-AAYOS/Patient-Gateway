...
public interface AppointmentQueryResourceApi {
    ...
    ResponseEntity<List<AppointmentDTO>> getAllAppointmentsUsingGET();
    ...
    @RequestMapping(value = "/api/query/_search/appointments",
        produces = "*/*", 
        method = RequestMethod.GET)
    ResponseEntity<List<AppointmentDTO>> searchAppointmentsUsingGET(@NotNull @ApiParam(value = "query", required = true) @Valid @RequestParam(value = "query", required = true) String query);
