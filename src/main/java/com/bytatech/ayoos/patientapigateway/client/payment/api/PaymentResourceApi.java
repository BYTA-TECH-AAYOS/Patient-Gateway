...
public interface PaymentResourceApi {
    ...
    @ApiOperation(value = "createPayment", nickname = "createPaymentUsingPOST1", notes = "", response = PaymentDTO.class, tags={ "payment-resource", })
    @ApiResponses(value = { 
    ...
    ResponseEntity<PaymentDTO> createPaymentUsingPOST1(@ApiParam(value = "paymentDTO" ,required=true )  @Valid @RequestBody PaymentDTO paymentDTO);


    @ApiOperation(value = "deletePayment", nickname = "deletePaymentUsingDELETE1", notes = "", tags={ "payment-resource", })
    @ApiResponses(value = { 
    ...
    ResponseEntity<Void> deletePaymentUsingDELETE1(@ApiParam(value = "id",required=true) @PathVariable("id") Long id);


    @ApiOperation(value = "getAllPayments", nickname = "getAllPaymentsUsingGET1", notes = "", response = PaymentDTO.class, responseContainer = "List", tags={ "payment-resource", })
    @ApiResponses(value = { 
    ...
    @RequestMapping(value = "/api/payments/{id}",
        produces = "*/*", 
        method = RequestMethod.GET)
    ResponseEntity<PaymentDTO> getPaymentUsingGET2(@ApiParam(value = "id",required=true) @PathVariable("id") Long id);


    @ApiOperation(value = "searchPayments", nickname = "searchPaymentsUsingGET1", notes = "", response = PaymentDTO.class, responseContainer = "List", tags={ "payment-resource", })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "OK", response = PaymentDTO.class, responseContainer = "List"),
        @ApiResponse(code = 401, message = "Unauthorized"),
        @ApiResponse(code = 403, message = "Forbidden"),
    ...
    ResponseEntity<PaymentDTO> updatePaymentUsingPUT1(@ApiParam(value = "paymentDTO" ,required=true )  @Valid @RequestBody PaymentDTO paymentDTO);
