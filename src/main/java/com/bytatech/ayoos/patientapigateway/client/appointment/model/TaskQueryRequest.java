...
import com.bytatech.ayoos.patientapigateway.client.appointment.model.QueryVariable;
...
public class TaskQueryRequest   {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.active, taskQueryRequest.active) &&
        ...
        Objects.equals(this.start, taskQueryRequest.start) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(active, assignee, assigneeLike, candidateGroup, candidateGroupIn, candidateOrAssigned, candidateUser, category, createdAfter, createdBefore, createdOn, delegationState, description, descriptionLike, dueAfter, dueBefore, dueDate, excludeSubTasks, executionId, includeProcessVariables, includeTaskLocalVariables, involvedUser, maximumPriority, minimumPriority, name, nameLike, order, owner, ownerLike, priority, processDefinitionId, processDefinitionKey, processDefinitionKeyLike, processDefinitionName, processDefinitionNameLike, processInstanceBusinessKey, processInstanceBusinessKeyLike, processInstanceId, processInstanceIdIn, processInstanceVariables, size, sort, start, taskDefinitionKey, taskDefinitionKeyLike, taskVariables, tenantId, tenantIdLike, unassigned, withoutDueDate, withoutTenantId);
  }
